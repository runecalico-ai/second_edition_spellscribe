...
## Purpose
The Settings Management capability defines configurable desktop settings for extraction, OCR, export defaults, and credential-source behavior, with explicit save/cancel persistence semantics.
