# Spell Extraction Review

## Purpose
The Spell Extraction Review capability runs Stage 2 LLM extraction on pending records, routes results to review or confirmed status, and provides a review/editing workflow so users can inspect, correct, and commit extracted spell data before export.
